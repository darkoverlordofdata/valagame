...
namespace Demo 
{
    public class Platformer : Microsoft.Xna.Framework.Game 
    {
        ...
        public OrthoCamera Camera;// = Vector2.Zero;
        ...
        public Platformer() 
        {
            ...
            graphics = new GraphicsDeviceManager(this, {50, 50, 700, 480 }); 
            Camera = new OrthoCamera(700, 480);
        }
        ...
        protected override void LoadContent()
        {
            ...
            Content.PreLoad("tiles");
            Content.PreLoad("backgrounds");
            Content.PreLoad("sounds");
            Content.PreLoad("levels");
        ...
        protected override void Update(GameTime gameTime)
        {
            if (Started)
            {
                ...
                Camera.MoveTo((int)Player.Position.X, (int)Player.Position.Y);
