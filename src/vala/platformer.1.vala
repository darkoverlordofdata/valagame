            ...
            while (Sdl.PollEvent(out evt) != 0) 
            {
                switch (evt.Type) 
                {
                    ...
                    case Sdl.EventType.KeyDown:
                        if (evt.Key.Keysym.Sym == 1073741904) { LeftHeld = true; }
                        if (evt.Key.Keysym.Sym == 1073741903) { RightHeld = true; }
                        if (evt.Key.Keysym.Sym == Keys.Escape) { Running = false; }
                    ...
                    case Sdl.EventType.KeyUp:
                        if (evt.Key.Keysym.Sym == 1073741904) { LeftHeld = false; }
                        if (evt.Key.Keysym.Sym == 1073741903) { RightHeld = false; }
                        break;
                }
            }
            UIEvent(evt);
